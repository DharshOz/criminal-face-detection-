...
#tk.Button(btn_frame, text="live Cam classification", command =live)
...
image_folder_path1=r"D:\MACHINE LEARNING\Facial-Recognition-for-Crime-Detection-master\Facial-Recognition-for-Crime-Detection-master\pre_processing"
preprocessed_images, image_labels = pre_processing(image_folder_path1)
eda(preprocessed_images, image_labels)
#compare_models_with_metrics() # type: ignore
